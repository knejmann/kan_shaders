...
void main(void) {
    ...
    // vec3 col = texture2DLod(source, uv, 0.2).rgb;
    ...
    float lum = texture2D(adsk_results_pass1, vec2(0.005)).r; // kald funktionen, der måler gennemsnit-lum i det definerede område
